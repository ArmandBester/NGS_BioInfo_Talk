---
title: "Adventures in bio-informatics"
...
::: {#fig-pickuplines layout-ncol=2}

![](media/PhyloPi_1.png)

![](media/PhyloPi_2.png)

Award for best pick up line
:::

##

::: {#fig-phylopi_overview layout-ncol=2}

![](media/pone.0213241.g002.png)

![](media/pone.0213241.g003.png){width=80%}

Pipeline overview and benchmarking
:::

##

::: {#fig-phylopi_dists layout-ncol=1}

![](media/pone.0213241.g004.png){width=80%}

 Genetic distance analysis of type inter and intra.
:::

##

::: {#fig-phylopi_rviews layout-ncol=1}

![](media/Rviews.png){width=100%}

 [https://rviews.rstudio.com/2019/04/30/analysing-hiv-pandemic-part-1/](https://rviews.rstudio.com/2019/04/30/analysing-hiv-pandemic-part-1/)
:::
...
blstDbAll = pd.read_csv("ampSorter_blst_nt.csv", delimiter="\t", names=names)
...
#| fig-cap: "Blast results"

px.scatter(data_frame=maxBitScr, x='BC', y='ssciname', 
           color='sskingdom', size='Frac', height=600, 
          hover_data = ['N'])
```
...
::: {#fig-P450 layout-ncol=1}

![](media/2j4s_assembly-1.jpeg)
...
* [Calculate distances](html/Distances.html)

* [Structure at RCSB](https://www.rcsb.org/structure/2J4S)
